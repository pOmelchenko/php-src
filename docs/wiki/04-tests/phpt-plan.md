...
2026-06-21 passed 6/6 in the same Docker debug environment. The Docker ZTS
debug build was not rerun after this alignment.
...
Current broad namespace-visibility result after Gate 3 edits: 18/18 passed in
...
Reason: Gate 3 covers the main VM/runtime/linking/type/callable/reflection and
serialization paths, but OPcache/preload/JIT behavior and performance evidence
are later gates.
